	...
	const themes = [
		{
			...
			tile: require('../../assets/sprites/empty-grass-tile.png').default,
			block: require('../../assets/sprites/brick-wall.png').default,
		},
		{
			id: 2,
			title: 'alien',
			image: require('../../assets/sprites/character-legs-apart.png')
				.default,
			tile: require('../../assets/sprites/empty-grass-tile.png').default,
